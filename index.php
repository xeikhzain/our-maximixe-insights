    ...
    <div class="container">
        <div class="row h-main-content">
            <div class="col-lg-6 col-md-6 col-sm-12 h-heading-content">
                ...
                <img src="./assets/Digital transformation-bro.png" alt="" class="h-first-img">
                <p class="main_p" id="h-heain-para">At Maximize Insights, our services are meticulously crafted to
                    guarantee you don't just exist in the digital landscape – you dominate it. Discover the best
                    language for web development with us as
                    your trusted front-end, Back-end, full-stack web development company.</p>
                <button class="Learn_more le_m" id="h-heain-para"> <a class="btn-a" href="about.php">Learn
                        more!</a></button>
                <!-- <br><br>
          <div class="frame">
            <div class="spinner1">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 h-img-contain">
                <img class="hero-img" src="./assets/Digital transformation-bro.png" alt="">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="tab-filter-item-container">
                <div class="row tab-item web-development select_tab">
                    <div class="col-md-5 tab-content-left">
                        <img height="" width="50px" src="assets/Code typing-bro.png" alt="web design" class="tab-img" />
                    </div>
                    <div class="col-md-7 tab-content-right">
                        <h1 class="tab-heading">Web Development</h1>
                        <p class="paragraph">
                            Take a digital leap with us. We excel in creating functional websites that flawlessly
                            exhibit your
                ...
                <div class="row tab-item web-design ">
                    <div class="col-md-5  tab-content-right">
                        <img src="assets/Social strategy-amico.png" alt="web development" class="tab-img" />
                    </div>
                    <div class="col-md-7  tab-content-left">
                        <h1 class="tab-heading">Social Media Marketing</h1>
                        <p class="paragraph">
                            Maximise Insights offers tailored Social Media Marketing packages for your business growth.
                            Our approach goes
                            beyond conventional strategies, encompassing full-service marketing, technology marketing,
                            and internet
                ...
                <div class="row tab-item ux-design">
                    <div class="col-md-5 tab-content-left">
                        <img src="assets/Designer girl-bro.png" alt="UI/UX Design" class="tab-img" />
                    </div>
                    <div class="col-md-7 tab-content-right">
                        <h1 class="tab-heading">Graphics Designing</h1>
                        <p class="paragraph">
                            Explore our expertise in graphic art and boost your brand with a visual designer for a
                            unique and
                            captivating online identity. Whether you want a simple design that resonates with your brand
                            philosophy
                            or wish to stand out among other graphic websites, our graphics design service is dedicated
                            to creating
                ...
                <div class="container tab-item app-development">
                    <div class="row tab-content-left">
                        <div class="col-md-5 tab-content-right">
                            <img src="./assets/SEO-rafiki.png" alt="UI/UX Design" class="tab-img seo-img" />
                        </div>
                        <div class="col-md-7">
                            <div class="software-service">
                                <h1 class="tab-heading">Search Engine Optimization</h1>
                                <p class="paragraph ">
                                    Have a vision for an application in mind? Our Software development expertise turns
                                    your ideas into
                                    reality. From conceptualisation to execution, let us help you develop user-friendly
                                    applications
                                    with the right functionalities.
                                </p>
                            </div>
                            <button class="Learn_more le_m"><a href="services.php" class="btn-a">Learn more!</a></button>
                            <br>
                        </div>
                    </div>
                </div>
...
<section style="position: relative;" class="industry">
    <div class="indus-head">
        ...
        <p class="para">Discover how the award-winning development team at Maximise Insights <br class="indus-br">
            leverages years of
                ...
                <div class="testmonial_slider_area text-center owl-carousel">
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <p class="contents">
                                “Maximise Insights has been a game-changer for our IT services company. Their commitment
                                to
                                transforming our online presence was evident from day one. Their creativity and
                                attention to detail
                                are truly exceptional. With precision and dedication, they reshaped our brand image,
                                aligning it
                    ...
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <p class="contents">
                                “Our experience working with Maximise Insights has been phenomenal. I needed a partner
                                who could bring
                                our vision to life in the digital space. Maximise Insights did just that and more. Their
                                team not only
                                delivered a dynamic website but also offered strategic insights that were a huge help
                                for our team.”
                            </p>
                            <h6 class="socials">
                                <i class="fa-solid fa-star"></i>
                    ...
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <p class="contents">
                                “HealthTech Innovations owes a great deal of its success to Maximise Insights. Their
                                innovative
                                strategies and commitment to delivering personalized solutions have been instrumental in
                                elevating our
                                brand in the competitive healthcare industry. They designed innovative web applications
                                Thank you to
                                all of you!”
                            </p>
                            <h6 class="socials">
                    ...
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <span> President</span>
                            <p class="contents">
                                “I had a wonderful experience working with Maximize Insights on a recent project, and I
                                couldn't be
                                more impressed with the results. From the initial concept to the final design, their
                                team demonstrated
                                a deep understanding of our vision. I recommend Maximize Insights to anyone looking for
                                professional
                                graphics designing.”
                            </p>
                            <h6 class="socials">
                    ...
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <p class="contents">
                                “Our shipping company has worked with Maximize Insights on several projects, including
                                our logo,
                                website, brochure, and business cards and they are simply the best! They more than
                                exceeded our
                                expectations and it was truly a pleasure working with them. I highly recommend
                                contacting Maximize
                    ...
                    <div class="testimonial-card">
                        <div class="box-area">
                            ...
                            <span> Owner</span>
                            <p class="contents">
                                “The digital marketing team at Maximize Insights has been a great help in driving our
                                e-commerce
                                business forward. They helped me transform my business from having no social presence at
                                all to now
                                fully optimized business pages and a strong presence on all major platforms. I am just
                                loving the
